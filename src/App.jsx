...
function VideoClip({ src, label }) {
  const [failed, setFailed] = useState(false);

  if (failed) {
    return (
      <div className="video-fallback" role="status">
        {label ? `${label} — ` : ''}video coming soon.
      </div>
    );
  }
        ...
        <section className="alt" id="s2">
          ...
          <div className="why-block" style={{ marginTop: '32px' }}>
            ...
            <div className="video-wrap" style={{ marginTop: '28px' }}>
              <VideoClip src="/video/sun.mp4" label="Android Studio walkthrough" />
            </div>
            ...
            <div className="video-wrap" style={{ marginTop: '28px' }}>
              <VideoClip src="/video/ios.mp4" label="Safari Web Inspector walkthrough" />
            </div>
